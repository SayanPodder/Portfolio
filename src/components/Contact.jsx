  ...
  { icon: '📞', label: '+44 7774 918531',                href: 'tel:+447774918531' },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" width="16" height="16">
        ...
        <path d="M12 0C5.373 0 0 5.373 0 12c0 2.123.554 4.118 1.524 5.855L.057 23.882
          l6.204-1.442A11.945 11.945 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0z
          M12 22c-1.885 0-3.652-.51-5.17-1.399l-.371-.22-3.684.856.895-3.567
          -.242-.381A9.944 9.944 0 012 12C2 6.477 6.477 2 12 2s10 4.477 10 10
          -4.477 10-10 10z"/>
      </svg>
    ),
    label: 'WhatsApp: +44 7774 918531',
    href:  'https://wa.me/447774918531',
  },
